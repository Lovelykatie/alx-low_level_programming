1 To write a script that runs a C file through the preprocessor and save the result into another file2 To Write a script that compiles a C file but does not link.
